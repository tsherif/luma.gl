...
var _drawModel2 = _interopRequireDefault(require("./draw-model"));

var DebugContext = function () {
  function DebugContext(sourceCanvas) {
    (0, _classCallCheck2["default"])(this, DebugContext);
  ...
  (0, _createClass2["default"])(DebugContext, [{
    key: "clear",
    ...
    value: function drawModel(model, opts) {
      (0, _drawModel2["default"])(Object.assign({}, opts, {
        model: model,
        draw: this._draw
      }));
    }
    ...
    value: function _clipspaceToScreen(position) {
      ...
      var _position = (0, _slicedToArray2["default"])(position, 4),
          x = _position[0],
          y = _position[1],
          z = _position[2],
          w = _position[3];
