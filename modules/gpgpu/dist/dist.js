...
/*!****************************!*\
  !*** ./src/diff-images.js ***!
  \****************************/
/*! exports provided: colorDelta, colorDeltaSq, diffImagePixels */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "colorDelta", function() { return colorDelta; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "colorDeltaSq", function() { return colorDeltaSq; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "diffImagePixels", function() { return diffImagePixels; });
/*
...
function diffImagePixels(data1, data2, colorDeltaThreshold = DEFAULT_THRESHOLD) {
...
/***/ "./src/histopyramid/histopyramid-shaders.js":
/*!**************************************************!*\
  !*** ./src/histopyramid/histopyramid-shaders.js ***!
  \**************************************************/
...
/***/ "./src/histopyramid/histopyramid.js":
/*!******************************************!*\
  !*** ./src/histopyramid/histopyramid.js ***!
  \******************************************/
...
/* harmony import */ var _histopyramid_shaders__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./histopyramid-shaders */ "./src/histopyramid/histopyramid-shaders.js");
...
function buildHistopyramidBaseLevel(gl, opts) {
  ...
  const baseTexture = Object(_luma_gl_core__WEBPACK_IMPORTED_MODULE_0__["cloneTextureFrom"])(texture, {
    width: size,
    height: size
  });

  // build individual pyramid textures
  const transform = new _luma_gl_core__WEBPACK_IMPORTED_MODULE_0__["Transform"](gl, {
    _sourceTextures: {
      inTexture: texture
    },
  ...
  const flatPyramidTexture = Object(_luma_gl_core__WEBPACK_IMPORTED_MODULE_0__["cloneTextureFrom"])(texture, {
    width: flatPyramidSize,
    height: flatPyramidSize,
    parameters: {
      [_luma_gl_constants__WEBPACK_IMPORTED_MODULE_1___default.a.TEXTURE_MAG_FILTER]: _luma_gl_constants__WEBPACK_IMPORTED_MODULE_1___default.a.NEAREST,
      [_luma_gl_constants__WEBPACK_IMPORTED_MODULE_1___default.a.TEXTURE_MIN_FILTER]: _luma_gl_constants__WEBPACK_IMPORTED_MODULE_1___default.a.NEAREST
    }
  });
  const framebuffer = transform.getFramebuffer();
  Object(_luma_gl_core__WEBPACK_IMPORTED_MODULE_0__["copyToTexture"])(framebuffer, flatPyramidTexture, {
    targetX: 0,
    width: size,
    height: size
  });
  ...
  if (levelCount > 1) {
    ...
    for (let i = 1; i < levelCount; i++) {
      ...
      pyramidTextures.push(
        Object(_luma_gl_core__WEBPACK_IMPORTED_MODULE_0__["cloneTextureFrom"])(baseTexture, {
          width: size,
          height: size
        })
      );
...
function histoPyramidGenerateIndices(gl, opts) {
  ...
  const keyIndex = new _luma_gl_core__WEBPACK_IMPORTED_MODULE_0__["Buffer"](gl, new Float32Array(keyIndexCount).map((_, index) => index));
  const locationAndIndex = new _luma_gl_core__WEBPACK_IMPORTED_MODULE_0__["Buffer"](gl, keyIndexCount * 4 * 4); // 4 floats for each key index
...
/*!**********************!*\
  !*** ./src/index.js ***!
  \**********************/
/*! exports provided: diffImagePixels, _buildHistopyramidBaseLevel, _getHistoPyramid, _histoPyramidGenerateIndices */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _diff_images__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./diff-images */ "./src/diff-images.js");
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "diffImagePixels", function() { return _diff_images__WEBPACK_IMPORTED_MODULE_0__["diffImagePixels"]; });

/* harmony import */ var _histopyramid_histopyramid__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./histopyramid/histopyramid */ "./src/histopyramid/histopyramid.js");
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "_buildHistopyramidBaseLevel", function() { return _histopyramid_histopyramid__WEBPACK_IMPORTED_MODULE_1__["buildHistopyramidBaseLevel"]; });

/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "_getHistoPyramid", function() { return _histopyramid_histopyramid__WEBPACK_IMPORTED_MODULE_1__["getHistoPyramid"]; });

/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "_histoPyramidGenerateIndices", function() { return _histopyramid_histopyramid__WEBPACK_IMPORTED_MODULE_1__["histoPyramidGenerateIndices"]; });
